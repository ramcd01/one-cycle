...
STRUCTURE_STEP2_PATH = STRUCTURE_DIR / "buid_domain_step2.py"
...
HWP_JAR_PATH = BASE_DIR / "libs" / "hwp" / "hwplib-1.1.8.jar"
HWPX_JAR_PATH = BASE_DIR / "libs" / "hwpx" / "hwpxlib-1.0.8.jar"
...
def validate_project_files() -> bool:
    ...
    if has_comparable_document:
        required_files.append(COMPARE_PARSER_PATH)
